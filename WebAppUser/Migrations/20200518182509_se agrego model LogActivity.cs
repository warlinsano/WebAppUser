...
{
    public partial class seagregomodelLogActivity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdActivityLog = table.Column<string>(nullable: false),
                    Date = table.Column<DateTime>(nullable: false),
                    Ip = table.Column<string>(nullable: false),
                    MacAddress = table.Column<string>(maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActivityLog", x => x.IdActivityLog);
                });
